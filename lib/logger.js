 ...
 * @returns {ErrorProps} Extracted error properties
 */
...
/**
 * @typedef {Object | false} LoggerOptions
 * @property {LogLevel} [level='debug'] Minimum log level
 * @property {boolean} [disabled=false] Disable logging if set to false
