...
import { getContentTypeFromData, getDataTypeFromContentType, bytesToString, format, DestroyedRequestError } from './utils.js';
...
export function handleError(err, { reqInfo, res, log }){
    ...
    if(originalErr instanceof DestroyedRequestError)
        res.finished = true;
