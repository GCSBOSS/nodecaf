...
export class EstelarInstance {
    ...
    async #_handleRequest(method, path, input){
        ...
        const args = Object.create(ctx.global ?? {});

        // Using prototypal inheritance ans 'assign' to improve v8 optimizations.
        Object.assign(args, {
            params: {},
            body: null,
            res,
        ...
        try{
            ...
            // Behind lazy getter so cookies are not parsed on every request, only if actually read by handler.
            if(typeof input.cookies == 'string')
                Object.defineProperty(args, 'cookies', {
                    get: () => {
                        const parsed = parse(String(input.cookies));
                        Object.defineProperty(args, 'cookies', { value: parsed });
                        return parsed;
                    },
                    configurable: true
                });
