...
const HTTP_VERBS = ['get', 'post', 'patch', 'put', 'head', 'options', 'trace'];
...
module.exports = class Nodecaf {
    ...
    constructor(conf){
        ...
        this._routeProxy = HTTP_VERBS.reduce( (o, method) =>
            ({ ...o, [method]: this._router.addRoute.bind(this._router, method) }), {});
