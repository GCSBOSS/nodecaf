...
import { bytesToString, getDataFromBytesAndTypes, getDataTypeFromContentType, readStream } from './utils.js';
...
export class Body {
    ...
    /** @type {import('./utils.js').ShortType} */
    #_type;

    /** @type {import('./utils.js').BufferEncoding} */
    #_charset;
