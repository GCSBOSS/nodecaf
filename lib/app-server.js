...
function findPkgInfo(){
    try{
        return require.main.require('../package.json');
    }
    catch(e){
...
module.exports = class AppServer {
    ...
    constructor(conf){
        ...
        this.confort.on('reload', this.restart.bind(this));
    ...
    async start(){
        ...
        this.confort.liveReload = this.watchConfFiles;
